  ...
  return (
    <div className="container mx-auto p-8 max-w-screen-xl">
      ...
      <section className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-center py-20 mt-8 rounded-lg shadow-md relative">
        <h2 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">Welcome to My Website</h2>
        <p className="text-xl text-white mb-8">Discover more about my project and services!</p>
        <Image
          src="/shawty.JPG"
          alt="JPG of my gf"
          ...
          layout="responsive"
        />
        <a href="#about" className="mt-8 inline-block bg-white text-primary px-6 py-3 rounded-full shadow hover:bg-secondary transition-transform transform hover:scale-105">
          Learn More
        </a>
